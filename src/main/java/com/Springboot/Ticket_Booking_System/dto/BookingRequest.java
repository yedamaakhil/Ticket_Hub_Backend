...
public class BookingRequest {
    ...
    public Map<String, Integer> getSeatPrices()                          { return seatPrices; }
    public void                 setSeatPrices(Map<String, Integer> p)    { this.seatPrices = p; }
    ...
    public void    setMoviePosterPath(String path)           { this.moviePosterPath = path; }
    ...
    public String toString() {
        return "BookingRequest [movieId=" + movieId
                + ", showDate=" + showDate
                + ", showTime=" + showTime
                + ", seats=" + seats
