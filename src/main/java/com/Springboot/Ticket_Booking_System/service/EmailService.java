...
public class EmailService {
    ...
    private String buildEmailHtml(Booking booking) {
        ...
        return "<!DOCTYPE html><html><head><meta charset='utf-8'>"
            ...
            + "    .ticket-card { border-radius: 12px !important; }"
            + "    .poster-cell { display: none !important; }"
            + "    .details-cell { width: 100% !important; padding: 12px 14px !important; }"
            + "    .barcode-cell { width: 100% !important; border-left: none !important; border-top: 1px solid #262626 !important; "
            + "      padding: 16px 10px !important; display: block !important; }"
            + "    .mobile-poster { display: block !important; width: 100% !important; max-width: 120px !important; "
            + "      margin: 0 auto 10px auto !important; border-radius: 8px !important; }"
            + "    .movie-title { font-size: 18px !important; }"
            + "    .movie-genre { font-size: 11px !important; }"
            + "    .status-badge { font-size: 9px !important; padding: 3px 10px !important; }"
            ...
            + "    .info-grid td { display: block !important; width: 100% !important; padding-bottom: 6px !important; }"
            + "    .info-grid td:last-child { padding-bottom: 0 !important; }"
            + "    .seats-price-row td { display: block !important; width: 100% !important; text-align: left !important; "
            + "      padding-bottom: 6px !important; }"
            + "    .seats-price-row td:last-child { padding-bottom: 0 !important; }"
            + "    .seats-price-row td[align='right'] { text-align: left !important; }"
            + "    .ref-text { font-size: 9px !important; }"
            + "  }"
            + "  @media only screen and (max-width: 400px) {"
            + "    .details-cell { padding: 10px 12px !important; }"
